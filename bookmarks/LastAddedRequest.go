...
func FinishLastAddedRequestBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
...
func FinishSizePrefixedLastAddedRequestBuffer(builder *flatbuffers.Builder, offset flatbuffers.UOffsetT) {
